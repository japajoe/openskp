...
public struct Sample : IFlatbufferObject
{
  ...
  public static Offset<openskp._fragments_fb.Sample> CreateSample(FlatBufferBuilder builder, uint Item, uint Material, uint Representation, uint LocalTransform) {
    builder.Prep(4, 16);
    builder.PutUint(LocalTransform);
    builder.PutUint(Representation);
    builder.PutUint(Material);
    builder.PutUint(Item);
    return new Offset<openskp._fragments_fb.Sample>(builder.Offset);
  }
}
