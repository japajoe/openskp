...
public struct ShellProfile : IFlatbufferObject
{
  ...
  public static Offset<openskp._fragments_fb.ShellProfile> CreateShellProfile(FlatBufferBuilder builder,
  ...
  public static Offset<openskp._fragments_fb.ShellProfile> EndShellProfile(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // indices
    return new Offset<openskp._fragments_fb.ShellProfile>(o);
  }
}
