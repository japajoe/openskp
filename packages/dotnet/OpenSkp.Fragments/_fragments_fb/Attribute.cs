...
public struct Attribute : IFlatbufferObject
{
  ...
  public static Offset<openskp._fragments_fb.Attribute> CreateAttribute(FlatBufferBuilder builder,
  ...
  public static Offset<openskp._fragments_fb.Attribute> EndAttribute(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<openskp._fragments_fb.Attribute>(o);
  }
}
