...
public struct Relation : IFlatbufferObject
{
  ...
  public static Offset<openskp._fragments_fb.Relation> CreateRelation(FlatBufferBuilder builder,
  ...
  public static Offset<openskp._fragments_fb.Relation> EndRelation(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<openskp._fragments_fb.Relation>(o);
  }
}
