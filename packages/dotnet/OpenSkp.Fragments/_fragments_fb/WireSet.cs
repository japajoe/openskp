...
public struct WireSet : IFlatbufferObject
{
  ...
  public openskp._fragments_fb.FloatVector? Ps(int j) { int o = __p.__offset(4); return o != 0 ? (openskp._fragments_fb.FloatVector?)(new openskp._fragments_fb.FloatVector()).__assign(__p.__vector(o) + j * 12, __p.bb) : null; }
  public int PsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<openskp._fragments_fb.WireSet> CreateWireSet(FlatBufferBuilder builder,
  ...
  public static Offset<openskp._fragments_fb.WireSet> EndWireSet(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<openskp._fragments_fb.WireSet>(o);
  }
}
...
static public class WireSetVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfData(tablePos, 4 /*Ps*/, 12 /*openskp._fragments_fb.FloatVector*/, false)
