...
public struct Model : IFlatbufferObject
{
  ...
  public openskp._fragments_fb.Meshes? Meshes { get { int o = __p.__offset(16); return o != 0 ? (openskp._fragments_fb.Meshes?)(new openskp._fragments_fb.Meshes()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public openskp._fragments_fb.Attribute? Attributes(int j) { int o = __p.__offset(18); return o != 0 ? (openskp._fragments_fb.Attribute?)(new openskp._fragments_fb.Attribute()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int AttributesLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public openskp._fragments_fb.Relation? Relations(int j) { int o = __p.__offset(20); return o != 0 ? (openskp._fragments_fb.Relation?)(new openskp._fragments_fb.Relation()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public openskp._fragments_fb.SpatialStructure? SpatialStructure { get { int o = __p.__offset(26); return o != 0 ? (openskp._fragments_fb.SpatialStructure?)(new openskp._fragments_fb.SpatialStructure()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public openskp._fragments_fb.ModelIndex? Indexes(int j) { int o = __p.__offset(32); return o != 0 ? (openskp._fragments_fb.ModelIndex?)(new openskp._fragments_fb.ModelIndex()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int IndexesLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<openskp._fragments_fb.Model> CreateModel(FlatBufferBuilder builder,
      ...
      Offset<openskp._fragments_fb.Meshes> meshesOffset = default(Offset<openskp._fragments_fb.Meshes>),
      ...
      Offset<openskp._fragments_fb.SpatialStructure> spatial_structureOffset = default(Offset<openskp._fragments_fb.SpatialStructure>),
  ...
  public static void AddMeshes(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Meshes> meshesOffset) { builder.AddOffset(6, meshesOffset.Value, 0); }
  ...
  public static VectorOffset CreateAttributesVector(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Attribute>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Attribute>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<openskp._fragments_fb.Attribute>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<openskp._fragments_fb.Attribute>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRelationsVector(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Relation>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Relation>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<openskp._fragments_fb.Relation>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<openskp._fragments_fb.Relation>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddSpatialStructure(FlatBufferBuilder builder, Offset<openskp._fragments_fb.SpatialStructure> spatialStructureOffset) { builder.AddOffset(11, spatialStructureOffset.Value, 0); }
  ...
  public static VectorOffset CreateIndexesVector(FlatBufferBuilder builder, Offset<openskp._fragments_fb.ModelIndex>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, Offset<openskp._fragments_fb.ModelIndex>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<openskp._fragments_fb.ModelIndex>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<openskp._fragments_fb.ModelIndex>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartIndexesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<openskp._fragments_fb.Model> EndModel(FlatBufferBuilder builder) {
    ...
    return new Offset<openskp._fragments_fb.Model>(o);
  }
  public static void FinishModelBuffer(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Model> offset) { builder.Finish(offset.Value, "0001"); }
  public static void FinishSizePrefixedModelBuffer(FlatBufferBuilder builder, Offset<openskp._fragments_fb.Model> offset) { builder.FinishSizePrefixed(offset.Value, "0001"); }
}
...
static public class ModelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyTable(tablePos, 16 /*Meshes*/, openskp._fragments_fb.MeshesVerify.Verify, true)
      && verifier.VerifyVectorOfTables(tablePos, 18 /*Attributes*/, openskp._fragments_fb.AttributeVerify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 20 /*Relations*/, openskp._fragments_fb.RelationVerify.Verify, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*RelationsItems*/, 4 /*int*/, false)
      && verifier.VerifyString(tablePos, 24 /*Guid*/, true)
      && verifier.VerifyTable(tablePos, 26 /*SpatialStructure*/, openskp._fragments_fb.SpatialStructureVerify.Verify, false)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 32 /*Indexes*/, openskp._fragments_fb.ModelIndexVerify.Verify, false)
