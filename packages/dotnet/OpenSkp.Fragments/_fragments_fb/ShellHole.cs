...
public struct ShellHole : IFlatbufferObject
{
  ...
  public static Offset<openskp._fragments_fb.ShellHole> CreateShellHole(FlatBufferBuilder builder,
  ...
  public static Offset<openskp._fragments_fb.ShellHole> EndShellHole(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // indices
    return new Offset<openskp._fragments_fb.ShellHole>(o);
  }
}
